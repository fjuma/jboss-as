...
public class UndertowTransformers implements ExtensionTransformerRegistration {
    ...
    private static final ModelVersion MODEL_VERSION_WILDFLY_17 = ModelVersion.create(9, 0, 0);
    ...
    public void registerTransformers(SubsystemTransformerRegistration subsystemRegistration) {
        ...
        registerTransformersWildFly17(chainedBuilder.createBuilder(subsystemRegistration.getCurrentSubsystemVersion(), MODEL_VERSION_WILDFLY_17));
        registerTransformersWildFly16(chainedBuilder.createBuilder(MODEL_VERSION_WILDFLY_17, MODEL_VERSION_WILDFLY_16));
        ...
        chainedBuilder.buildAndRegister(subsystemRegistration, new ModelVersion[]{MODEL_VERSION_WILDFLY_17, MODEL_VERSION_WILDFLY_16, MODEL_VERSION_EAP7_2_0, MODEL_VERSION_EAP7_1_0, MODEL_VERSION_EAP7_0_0});
    }

    private static void registerTransformersWildFly17(ResourceTransformationDescriptionBuilder subsystemBuilder) {
