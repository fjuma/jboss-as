...
public class DiscoveryGroupAdd extends ShallowResourceAdd {
    ...
    private DiscoveryGroupAdd(boolean isLegacyCall) {
        super(isLegacyCall, DiscoveryGroupDefinition.ATTRIBUTES);
    }
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        ...
        if (!isLegacyCall) {
            ...
            if (operation.hasDefined(JGROUPS_CLUSTER.getName())) {
                target = target.append(CommonAttributes.JGROUP_DISCOVERY_GROUP, context.getCurrentAddressValue());
                addHandler = JGroupDiscoveryGroupAdd.LEGACY_INSTANCE;
            } else {
