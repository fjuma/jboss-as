...
import org.wildfly.extension.messaging.activemq.JGroupDiscoveryGroupAdd;
        ...
        try {
            ...
            if (discoveryGroupConfiguration != null) {
                ...
                if (commandDispatcherFactories.containsKey(key)) {
                    ...
                    config = JGroupDiscoveryGroupAdd.createDiscoveryGroupConfiguration(name, discoveryGroupConfiguration, commandDispatcherFactory, clusterName);
                } else {
