 ...
 */
public class JGroupBroadcastGroupRemove extends AbstractRemoveStepHandler {
    ...
    public static final JGroupBroadcastGroupRemove INSTANCE = new JGroupBroadcastGroupRemove(true);
    public static final JGroupBroadcastGroupRemove LEGACY_INSTANCE = new JGroupBroadcastGroupRemove(false);

    private final boolean needLegacyCall;

    private JGroupBroadcastGroupRemove(boolean needLegacyCall) {
        super();
