...
import static org.wildfly.extension.messaging.activemq.MessagingExtension.JGROUP_BROADCAST_GROUP_PATH;
...
public class BroadcastGroupWriteAttributeHandler extends ReloadRequiredWriteAttributeHandler {
    ...
    public static final BroadcastGroupWriteAttributeHandler JGROUP_INSTANCE = new BroadcastGroupWriteAttributeHandler(JGROUP_BROADCAST_GROUP_PATH, JGroupBroadcastGroupDefinition.ATTRIBUTES);
    public static final BroadcastGroupWriteAttributeHandler SOCKET_INSTANCE = new BroadcastGroupWriteAttributeHandler(SOCKET_BROADCAST_GROUP_PATH, JGroupBroadcastGroupDefinition.ATTRIBUTES);
