...
public class DiscoveryGroupRemove extends AbstractRemoveStepHandler {
    ...
    public void execute(OperationContext context, ModelNode operation) throws OperationFailedException {
        if (!isLegacyCall) {
            ...
            try {
                context.readResourceFromRoot(target.append(CommonAttributes.JGROUP_DISCOVERY_GROUP, context.getCurrentAddressValue()));
                target = target.append(CommonAttributes.JGROUP_DISCOVERY_GROUP, context.getCurrentAddressValue());
                removeHandler = JGroupDiscoveryGroupRemove.LEGACY_INSTANCE;
