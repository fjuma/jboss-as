...
public class MessagingExtension implements Extension {
    ...
    static final PathElement JGROUP_BROADCAST_GROUP_PATH = pathElement(JGROUP_BROADCAST_GROUP);
    ...
    public void initialize(ExtensionContext context) {
        ...
        subsystem.registerSubModel(new JGroupDiscoveryGroupDefinition(registerRuntimeOnly, true));
