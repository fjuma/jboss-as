...
public class MessagingSubsystemParser_9_0 extends PersistentResourceXMLParser {
    ...
    public PersistentResourceXMLDescription getParserDescription() {
        ...
        final PersistentResourceXMLBuilder jgroupDiscoveryGroup = builder(JGroupDiscoveryGroupDefinition.PATH)
                .addAttributes(
                                ...
                                .addChild(
                                        builder(pathElement(ACCEPTOR))
                                                .addAttributes(
                                                        ...
                                                        CommonAttributes.PARAMS))
                                .addChild(
                                        builder(MessagingExtension.JGROUP_BROADCAST_GROUP_PATH)
                                                .addAttributes(
