...
public class BroadcastGroupDefinition extends ShallowResourceDefinition {
    ...
    private static String getBroadCastGroupName(ModelNode node) {
        ...
        if(node.hasDefined(CommonAttributes.JGROUP_BROADCAST_GROUP)) {
            return node.get(CommonAttributes.JGROUP_BROADCAST_GROUP).asString();
        }
    ...
    public PathAddress convert(OperationContext context, ModelNode operation) {
        ...
        PathAddress targetAddress = parent.append(CommonAttributes.JGROUP_BROADCAST_GROUP, context.getCurrentAddressValue());
        try {
    ...
    public Set<String> getIgnoredAttributes(OperationContext context, ModelNode operation) {
        PathAddress targetAddress = context.getCurrentAddress().getParent().append(CommonAttributes.JGROUP_BROADCAST_GROUP, context.getCurrentAddressValue());
