 ...
 */
public class JGroupBroadcastGroupDefinition extends PersistentResourceDefinition {

    public static final RuntimeCapability<Void> CAPABILITY = RuntimeCapability.Builder.of("org.wildfly.messaging.activemq.jgroup-broadcast-group", true)
    ...
    JGroupBroadcastGroupDefinition(boolean registerRuntimeOnly) {
        super(new SimpleResourceDefinition.Parameters(
                MessagingExtension.JGROUP_BROADCAST_GROUP_PATH,
                MessagingExtension.getResourceDescriptionResolver(CommonAttributes.BROADCAST_GROUP))
                    .setAddHandler(JGroupBroadcastGroupAdd.INSTANCE)
                    .setRemoveHandler(JGroupBroadcastGroupRemove.INSTANCE)
