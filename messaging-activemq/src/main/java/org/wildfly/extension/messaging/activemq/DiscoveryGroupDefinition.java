...
public class DiscoveryGroupDefinition extends ShallowResourceDefinition {
    ...
    public PathAddress convert(OperationContext context, ModelNode operation) {
        ...
        PathAddress targetAddress = parent.append(CommonAttributes.JGROUP_DISCOVERY_GROUP, context.getCurrentAddressValue());
        try {
    ...
    public Set<String> getIgnoredAttributes(OperationContext context, ModelNode operation) {
        PathAddress targetAddress = context.getCurrentAddress().getParent().append(CommonAttributes.JGROUP_DISCOVERY_GROUP, context.getCurrentAddressValue());
