...
public class MessagingTransformerRegistration implements ExtensionTransformerRegistration {
    ...
    private static void registerTransformers_WF_19(ResourceTransformationDescriptionBuilder subsystem) {
        ...
        subsystem.addChildRedirection(JGroupDiscoveryGroupDefinition.PATH, DiscoveryGroupDefinition.PATH);
        ...
        server.addChildRedirection(MessagingExtension.JGROUP_BROADCAST_GROUP_PATH, MessagingExtension.BROADCAST_GROUP_PATH);
        server.addChildRedirection(MessagingExtension.SOCKET_BROADCAST_GROUP_PATH, MessagingExtension.BROADCAST_GROUP_PATH);
        server.addChildRedirection(JGroupDiscoveryGroupDefinition.PATH, DiscoveryGroupDefinition.PATH);
