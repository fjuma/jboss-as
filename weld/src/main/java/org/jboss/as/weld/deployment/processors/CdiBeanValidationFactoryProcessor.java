...
/**
 * Replaces the delegate of LazyValidatorFactory with a CDI-enabled ValidatorFactory.
 *
 * @author Farah Juma
 */
public class CdiBeanValidationFactoryProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        final CdiValidatorFactoryService cdiValidatorFactoryService = new CdiValidatorFactoryService(deploymentUnit, module.getClassLoader());
        serviceTarget.addService(deploymentUnit.getServiceName().append(CdiValidatorFactoryService.SERVICE_NAME), cdiValidatorFactoryService)
