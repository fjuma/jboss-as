...
public class ApplicationSecurityDomainDefinition extends SimpleResourceDefinition {
    ...
    static final SimpleAttributeDefinition SECURITY_DOMAIN_REF = new SimpleAttributeDefinitionBuilder(EJB3SubsystemModel.SECURITY_DOMAIN_REF, ModelType.STRING, false)
    ...
    private static final AttributeDefinition[] ATTRIBUTES = new AttributeDefinition[] { SECURITY_DOMAIN_REF };
    ...
    private static class AddHandler extends AbstractAddStepHandler {
        ...
        protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model) throws OperationFailedException {
            String securityDomainRef = SECURITY_DOMAIN_REF.resolveModelAttribute(context, model).asString();
            ...
            serviceBuilder.addDependency(context.getCapabilityServiceName(
                    buildDynamicCapabilityName(SECURITY_DOMAIN_CAPABILITY, securityDomainRef), SecurityDomain.class),
    ...
    private static class RemoveHandler extends ServiceRemoveStepHandler {
        ...
        protected ServiceName serviceName(String name) {
            ...
            return dynamicCapability.getCapabilityServiceName(SecurityDomain.class);
        }
    }
