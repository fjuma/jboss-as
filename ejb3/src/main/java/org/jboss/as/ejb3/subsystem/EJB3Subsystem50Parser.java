...
public class EJB3Subsystem50Parser extends EJB3Subsystem40Parser {
    ...
    private void parseApplicationSecurityDomain(final XMLExtendedStreamReader reader, final List<ModelNode> operations) throws XMLStreamException {
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attribute) {
                case SECURITY_DOMAIN:
                    ...
                    break;
                case SECURITY_DOMAIN_REF:
                    ApplicationSecurityDomainDefinition.SECURITY_DOMAIN_REF.parseAndSetParameter(attributeValue, operation, reader);
                    break;
                default:
        ...
        if (applicationSecurityDomain == null) {
            throw missingRequired(reader, Collections.singleton(EJB3SubsystemXMLAttribute.SECURITY_DOMAIN.getLocalName()));
        }
